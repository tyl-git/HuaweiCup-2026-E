"""Train the locked temporal architecture with a class-balanced selection loss.
...
OUT = RESULTS / "q2-balanced-selection-v1.2"
...
def main():
    ...
    (OUT / "provenance.json").write_text(json.dumps({
        "schema": "q2_balanced_selection_v1.0", "train_n": len(train), "valid_n": len(valid),
        "test_evaluated": False, "specialists_evaluated": False,
        "selection_split": "valid_complete", "selection_loss": "train-derived sqrt-balanced CE + L1",
    ...
    print(f"Balanced-selection train/valid complete: {OUT}; test and specialists untouched")
